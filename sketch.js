...
var zombie, zombieImg, playerZombieImg, playerZombie;
...
function preload(){
  ...
  playerZombieImg = loadImage("assets/shooter_zombie.png");
...
if(keyDown("DOWN_ARROW") && player.y < 650){
 player.y = player.y+30;
}
...
if(gameState == "lost"){
  ...
  player.addImage(playerZombieImg);
}
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(700,1100),random(350,700),40,40)
